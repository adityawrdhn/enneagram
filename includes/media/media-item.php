							...
							<div class="media-item animate-onscroll <?php if($type == 'gallery') echo 'gallery-media'; ?>">
								...
								<div class="media-image">
									...
									<img src="<?php if(isset($media['thumb'])) echo base_url()."assets/".$media['thumb']; ?>" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="<?php if(isset($media['jackbox-link'])) echo $media['jackbox-link']; ?>" data-group="media-jackbox" data-thumbnail="<?php if(isset($media['thumb'])) echo $media['thumb']; ?>" class="jackbox media-icon"><i class="icons <?php if($media['format'] == 'image') echo 'icon-zoom-in'; else if($media['format'] == 'video') echo 'icon-play'; ?>"></i></a>
